//
//  LocationSearchTblViewCellTableViewCell.swift
//  kj
//
...
class LocationSearchTblViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        background.layer.borderColor = (UIColor.flatWatermelon()).cgColor
